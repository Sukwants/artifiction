...
use crate::common::{Element, Moonsign, StellarGlimmerState, item_config_type::ConfigElements8Multi};

#[derive(Serialize, Deserialize, Clone)]
pub enum CharacterConfig {
    AetherAnemo { elements: ConfigElements8Multi },
    LumineAnemo { elements: ConfigElements8Multi },
    AetherGeo { elements: ConfigElements8Multi },
    LumineGeo { elements: ConfigElements8Multi },
    AetherElectro { abundance_amulet_count: usize, elements: ConfigElements8Multi },
    LumineElectro { abundance_amulet_count: usize, elements: ConfigElements8Multi },
    AetherDendro { elements: ConfigElements8Multi },
    LumineDendro { elements: ConfigElements8Multi },
    AetherHydro { elements: ConfigElements8Multi },
    LumineHydro { elements: ConfigElements8Multi },
    AetherPyro { elements: ConfigElements8Multi },
    LuminePyro { elements: ConfigElements8Multi },
    Razor { e_stack: f64, talent2_ratio: f64 },
    Beidou { stellar_glimmer_state: StellarGlimmerState },
    Ningguang { talent2_rate: f64 },
    Fischl { hexerei_secret_rite: bool, elements: ConfigElements8Multi },
    Sucrose { hexerei_secret_rite: bool, elements: ConfigElements8Multi },
    Qiqi { stellar_glimmer_state: StellarGlimmerState, stellar_conduct_application_count: usize },
    Keqing { talent2_rate: f64 },
    Venti { hexerei_secret_rite: bool, elemental_absorption: Option<Element> },
    Klee { hexerei_secret_rite: bool },
    Diona { stellar_glimmer_state: StellarGlimmerState },
    ...
    YaeMiko { stellar_glimmer_state: StellarGlimmerState, stellar_conduct_application_count: usize },
    ...
    Candace { c2_rate: f64 },
    Cyno { c2_stack: f64, after_q: bool, stellar_conduct_application_count: usize, stellar_glimmer_state: StellarGlimmerState },
    ...
    Wriothesley { stellar_glimmer_state: StellarGlimmerState, stellar_conduct_application_count: usize, talent2_stack: f64 },
    ...
    Sandrone { stellar_glimmer_state: StellarGlimmerState, stellar_conduct_application_count: usize },
    AetherCryo { elements: ConfigElements8Multi, stellar_conduct_application_count: usize, stellar_glimmer_state: StellarGlimmerState },
    LumineCryo { elements: ConfigElements8Multi, stellar_conduct_application_count: usize, stellar_glimmer_state: StellarGlimmerState },
