...
pub enum CharacterConfig {
    ...
    Beidou { stellar_glimmer_state: usize },
    ...
    YaeMiko { stellar_glimmer_state: usize, stellar_conduct_application_count: usize },
    ...
    Candace { c2_rate: f64 },
    Cyno { c2_stack: f64, after_q: bool, stellar_conduct_application_count: usize, stellar_glimmer_state: usize },
    ...
    Wriothesley { stellar_glimmer_state: usize, stellar_conduct_application_count: usize, talent2_stack: f64 },
    ...
    Sandrone { stellar_glimmer_state: usize, stellar_conduct_application_count: usize },
    AetherCryo { elements: ConfigElements8Multi, stellar_conduct_application_count: usize, stellar_glimmer_state: usize },
    LumineCryo { elements: ConfigElements8Multi, stellar_conduct_application_count: usize, stellar_glimmer_state: usize },
    // Skirk { death_crossing_stacks: usize, team_has_hydro_cryo: bool },
    Alyosha { stellar_glimmer_state: usize },
    Odette { stellar_glimmer_state: usize, stellar_conduct_application_count: usize, marvelous_splendor_self: f64, marvelous_splendor_other: f64 },
    NoConfig,
}
