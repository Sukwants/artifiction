...
pub const IFA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [845, 2171, 2803, 4198, 4647, 5345, 5943, 6641, 7090, 7787, 8236, 8934, 9383, 10081, 10778],
    atk: [15,38,50,74,82,95,105,118,125,138,146,158,166,178, 224],
    def: [51,130,168,252,279,321,357,399,426,468,495,537,563,605, 647],
