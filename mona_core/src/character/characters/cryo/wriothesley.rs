...
pub const WRIOTHESLEY_SKILL: WriothesleySkillType = WriothesleySkillType {
    a_dmg1: [0.533596, 0.577028, 0.62046, 0.682506, 0.725938, 0.775575, 0.843826, 0.912076, 0.980327, 1.054782, 1.129237, 1.203692, 1.278148, 1.352603, 1.427058],
    a_dmg2: [0.517987, 0.560148, 0.60231, 0.662541, 0.704703, 0.752888, 0.819142, 0.885396, 0.95165, 1.023927, 1.096204, 1.168481, 1.240759, 1.313036, 1.385313],
    a_dmg3: [0.672228, 0.726944, 0.78166, 0.859826, 0.914542, 0.977075, 1.063058, 1.14904, 1.235023, 1.328822, 1.422621, 1.51642, 1.61022, 1.704019, 1.797818],
    a_dmg4: [0.379041, 0.409893, 0.440745, 0.48482, 0.515672, 0.550931, 0.599413, 0.647895, 0.696377, 0.749266, 0.802156, 0.855045, 0.907935, 0.960824, 1.013713],
    a_dmg5: [0.90742, 0.98128, 1.05514, 1.160654, 1.234514, 1.318925, 1.43499, 1.551056, 1.667121, 1.793738, 1.920355, 2.046972, 2.173588, 2.300205, 2.426822],
    z_dmg: [1.5296, 1.64432, 1.75904, 1.912, 2.02672, 2.14144, 2.2944, 2.44736, 2.60032, 2.75328, 2.90624, 3.0592, 3.2504, 3.4416, 3.6328],
...
impl CharacterTrait for Wriothesley {
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig, fumo: Option<Element>) -> D::Result {
        ...
        let mut ratio = match s {
            A1 => WRIOTHESLEY_SKILL.a_dmg1[s1],
            A2 => WRIOTHESLEY_SKILL.a_dmg2[s1],
            A3 => WRIOTHESLEY_SKILL.a_dmg3[s1],
            A4Div2 => WRIOTHESLEY_SKILL.a_dmg4[s1],
            A5 => WRIOTHESLEY_SKILL.a_dmg5[s1],
            Z => WRIOTHESLEY_SKILL.z_dmg[s1],
            X1 => WRIOTHESLEY_SKILL.x_dmg1[s1],
            X2 => WRIOTHESLEY_SKILL.x_dmg2[s1],
            X3 => WRIOTHESLEY_SKILL.x_dmg3[s1],
            Q1 => WRIOTHESLEY_SKILL.q_dmg1[s3],
            Q2 => WRIOTHESLEY_SKILL.q_dmg2[s3],
            C6_A5 => WRIOTHESLEY_SKILL.a_dmg5[s1],
            C6_Z => WRIOTHESLEY_SKILL.z_dmg[s1],
        };
