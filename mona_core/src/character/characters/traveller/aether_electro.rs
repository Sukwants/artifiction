...
pub struct AetherElectroSkillType {
    pub a_dmg1: [f64; 15],
    pub a_dmg2: [f64; 15],
    pub a_dmg3: [f64; 15],
    pub a_dmg4: [f64; 15],
...
pub const AETHERELECTRO_SKILL: AetherElectroSkillType = AetherElectroSkillType {
...
pub const AETHERELECTRO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    name: CharacterName::AetherElectro,
    internal_name: "AetherElectro",
...
pub struct AetherElectroEffect {
...
impl<A: Attribute> ChangeAttribute<A> for AetherElectroEffect {
...
impl AetherElectroDamageEnum {
    pub fn get_element(&self) -> Element {
        use AetherElectroDamageEnum::*;
        match *self {
...
pub struct AetherElectro;

impl CharacterTrait for AetherElectro {
    const STATIC_DATA: CharacterStaticData = AETHERELECTRO_STATIC_DATA;
    type SkillType = AetherElectroSkillType;
    const SKILL: Self::SkillType = AETHERELECTRO_SKILL;
    type DamageEnumType = AetherElectroDamageEnum;
    type RoleEnum = ();
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig, fumo: Option<Element>) -> D::Result {
        let s: AetherElectroDamageEnum = num::FromPrimitive::from_usize(s).unwrap();
        ...
        let ratio = match s {
            A1 => AETHERELECTRO_SKILL.a_dmg1[s1],
            A2 => AETHERELECTRO_SKILL.a_dmg2[s1],
            A3 => AETHERELECTRO_SKILL.a_dmg3[s1],
            A4 => AETHERELECTRO_SKILL.a_dmg4[s1],
            A5 => AETHERELECTRO_SKILL.a_dmg5[s1],
            Z1 => AETHERELECTRO_SKILL.z_dmg1[s1],
            Z2 => AETHERELECTRO_SKILL.z_dmg2[s1],
            X1 => AETHERELECTRO_SKILL.x_dmg1[s1],
            X2 => AETHERELECTRO_SKILL.x_dmg2[s1],
            X3 => AETHERELECTRO_SKILL.x_dmg3[s1],
            E => AETHERELECTRO_SKILL.e_dmg[s2],
            Q => AETHERELECTRO_SKILL.q_dmg[s3],
            QT => AETHERELECTRO_SKILL.q_dmgt[s3],
            QC6 => AETHERELECTRO_SKILL.q_dmgt[s3] * 2.0,
            P3A => AETHERELECTRO_SKILL.z_dmg1[s1] + AETHERELECTRO_SKILL.p3_bonus,
            P3B => AETHERELECTRO_SKILL.z_dmg2[s1] + AETHERELECTRO_SKILL.p3_bonus,
            P3T => AETHERELECTRO_SKILL.z_dmg1[s1] + AETHERELECTRO_SKILL.z_dmg2[s1] + 2.0 * AETHERELECTRO_SKILL.p3_bonus,
            P3L => AETHERELECTRO_SKILL.p3_lightning_bonus,
            _ => 0.0
        };
    ...
    fn new_effect<A: Attribute>(common_data: &CharacterCommonData, config: &CharacterConfig) -> Option<Box<dyn ChangeAttribute<A>>> {
        let (elements, abundance_amulet_count) = match config {
            CharacterConfig::AetherElectro { elements, abundance_amulet_count } => (*elements, *abundance_amulet_count),
            _ => (ConfigElements8Multi::default(), 0),
        };
        Some(Box::new(AetherElectroEffect {
            elements,
