...
impl CharacterTrait for LumineAnemo {
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig, fumo: Option<Element>) -> D::Result {
        ...
        let (wind_elements, elemental_absorption) = match *config {
            CharacterSkillConfig::LumineAnemo { elemental_absorption, wind_elements } => (wind_elements, elemental_absorption),
        ...
        let ratio = match s {
            ...
            P3A => LUMINEANEMO_SKILL.z_dmg1[s1] + LUMINEANEMO_SKILL.p3_bonus,
            P3B => LUMINEANEMO_SKILL.z_dmg2[s1] + LUMINEANEMO_SKILL.p3_bonus,
            P3T => LUMINEANEMO_SKILL.z_dmg1[s1] + LUMINEANEMO_SKILL.z_dmg2[s1] + 2.0 * LUMINEANEMO_SKILL.p3_bonus,
            P3W_Pyro | P3W_Hydro | P3W_Cryo | P3W_Electro => LUMINEANEMO_SKILL.p3_wind_bonus,
            _ => 0.0
        };
    ...
    fn new_effect<A: Attribute>(common_data: &CharacterCommonData, config: &CharacterConfig) -> Option<Box<dyn ChangeAttribute<A>>> {
        let elements = match *config {
            CharacterConfig::LumineAnemo { elements } => elements,
