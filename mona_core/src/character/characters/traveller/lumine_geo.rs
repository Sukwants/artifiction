...
pub struct LumineGeo;

impl CharacterTrait for LumineGeo {
    const STATIC_DATA: CharacterStaticData = LUMINEGEO_STATIC_DATA;
    type SkillType = LumineGeoSkillType;
    const SKILL: Self::SkillType = LUMINEGEO_SKILL;
    type DamageEnumType = LumineGeoDamageEnum;
    type RoleEnum = ();
    ...
    fn damage_internal<D: DamageBuilder>(context: &DamageContext<'_, D::AttributeType>, s: usize, config: &CharacterSkillConfig, fumo: Option<Element>) -> D::Result {
        ...
        let ratio = match s {
            A1 => LUMINEGEO_SKILL.a_dmg1[s1],
            A2 => LUMINEGEO_SKILL.a_dmg2[s1],
            A3 => LUMINEGEO_SKILL.a_dmg3[s1],
            A4 => LUMINEGEO_SKILL.a_dmg4[s1],
            A5 => LUMINEGEO_SKILL.a_dmg5[s1],
            Z1 => LUMINEGEO_SKILL.z_dmg1[s1],
            Z2 => LUMINEGEO_SKILL.z_dmg2[s1],
            X1 => LUMINEGEO_SKILL.x_dmg1[s1],
            X2 => LUMINEGEO_SKILL.x_dmg2[s1],
            X3 => LUMINEGEO_SKILL.x_dmg3[s1],
