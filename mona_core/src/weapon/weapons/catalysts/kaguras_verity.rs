...
use crate::common::{ReactionType, WeaponType};
...
impl WeaponTrait for KagurasVerity {
    const META_DATA: WeaponStaticData = WeaponStaticData {
        ...
        effect: Some(crate::common::i18n::locale!(
            zh_cn: "施放元素战技时，将获得「神乐舞」的效果，使装备该武器的角色的元素战技造成的伤害提高<span style=\"color: #409EFF;\">12%-15%-18%-21%-24%</span>，造成的星超导反应伤害提升<span style=\"color: #409EFF;\">12%-15%-18%-21%-24%</span>，该效果持续24秒，至多叠加3层。持有3层时，该角色获得<span style=\"color: #409EFF;\">12%-15%-18%-21%-24%</span>所有元素伤害加成。",
            en: "Using an Elemental Skill grants the Kagura Dance effect, increasing the wielding character's Elemental Skill DMG by <span style=\"color: #409EFF;\">12%-15%-18%-21%-24%</span> as well as their Stellar-Conduct DMG by <span style=\"color: #409EFF;\">12%-15%-18%-21%-24%</span> for 24s. Max 3 stacks. This character will gain <span style=\"color: #409EFF;\">12%-15%-18%-21%-24%</span> All Elemental DMG Bonus when they possess 3 stacks."
        )),
        #[cfg(not(target_family = "wasm"))]
