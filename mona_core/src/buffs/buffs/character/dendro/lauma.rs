...
impl<A: Attribute> Buff<A> for BuffLauma {
    fn change_attribute(&self, attribute: &mut A) {
        ...
        attribute.set_value_to(AttributeName::IncreaseLunarBloom, "菈乌玛「奉向霜夜的明光」", (self.em * 0.000175).min(0.14));
    }
}

impl BuffMeta for BuffLauma {
    ...
    const META_DATA: BuffMetaData = BuffMetaData {
        ...
        description: Some(locale!(
            zh_cn: "苍色祷歌：队伍中附近的角色造成绽放、超绽放、烈绽放、月绽放反应伤害时，将消耗一层「苍色祷歌」，提升造成的伤害，提升值基于菈乌玛的元素精通。上述伤害同时命中多名敌人时，会依据命中敌人的数量消耗「苍色祷歌」层数。\
                <br>C2：「苍色祷歌」的效果提升：队伍中附近的所有角色触发绽放、超绽放、烈绽放反应时造成的伤害额外提升，提升值相当于菈乌玛元素精通的500%；队伍中附近的所有角色造成的月绽放反应伤害额外提升，提升值相当于菈乌玛元素精通的400%。\
                <br><br>天赋 - 奉向霜夜的明光：菈乌玛施放元素战技圣言述咏·终宵永眠后的20秒内，将依据队伍的月兆，分别产生不同的强化效果，不同月兆等级提供的强化效果无法叠加。\
                ...
                <br><br>天赋 - 月兆祝赐·千籁恩宠：队伍中的角色触发绽放反应时，将转为触发月绽放反应，且基于菈乌玛的元素精通，提升队伍中角色造成的月绽放反应的基础伤害：每点元素精通都将提升0.0175%月绽放反应的基础伤害，至多通过这种方式提升14%伤害。",
            en: "When nearby party members deal Bloom, Hyperbloom, Burgeon, or Lunar-Bloom DMG, 1 stack of Pale Hymn will be consumed and the DMG dealt will be increased based on Lauma's Elemental Mastery. If this DMG hits multiple opponents at once, then multiple stacks of Pale Hymn will be consumed, depending on how many opponents are hit.\
                <br>Pale Hymn effects are increased: All nearby party members' Bloom, Hyperbloom, and Burgeon DMG is further increased by 500% of Lauma's Elemental Mastery, and their Lunar-Bloom DMG is further increased by 400% of Lauma's Elemental Mastery.\
                <br><br>Talent - Light for the Frosty Night: For the next 20s after Lauma uses her Elemental Skill Runo: Dawnless Rest of Karsikko, corresponding differing buff effects will be granted depending on the party's Moonsign. The buffs provided by different Moonsign levels cannot stack.\
                ...
                <br><br>Talent - Moonsign Benediction: Nature's Chorus: When a party member triggers a Bloom reaction, it will be converted into the Lunar-Bloom reaction, with every point of Elemental Mastery that Lauma has increasing Lunar-Bloom's Base DMG by 0.0175%, up to a maximum of 14%."
        )),
    ...
    const CONFIG: Option<&'static [ItemConfig]> = Some(&[
        ...
        ItemConfig {
            ...
            title: locale!(
                zh_cn: "天赋：奉向霜夜的明光",
                en: "Talent: Light for the Frosty Night"
            ),
            config: ItemConfigType::Bool { default: false }
        },
        ItemConfig {
    ...
    fn create<A: Attribute>(b: &BuffConfig) -> Box<dyn Buff<A>> {
        let (em, activated_q, level_q, has_p1, has_c2, moonsign) = match *b {
            BuffConfig::Lauma { em, activated_q, level_q, has_p1, has_c2, moonsign } => (em, activated_q, level_q, has_p1, has_c2, moonsign),
            _ => (0.0, false, 1, false, false, Moonsign::None)
        };
        Box::new(BuffLauma {
            em,
            activated_q,
